...
export function ReportCard({ stat }: ReportCardProps) {
    ...
    return (
        <ReportDetails stat={stat}>
            <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300 bg-white rounded-[2rem] overflow-hidden ring-1 ring-slate-100 group cursor-pointer">
